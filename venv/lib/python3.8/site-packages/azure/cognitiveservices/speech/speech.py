...
class Recognizer():
    ...
    def stop_continuous_recognition(self):
        ...
        """
        return self._impl.stop_continuous_recognition_async().get()
...
class SpeechRecognizer(Recognizer):
    ...
    def __init__(self,
        ...
        self._impl = self._get_impl(impl.SpeechRecognizer, speech_config, audio_config, language,
                                    source_language_config, auto_detect_source_language_config)
    ...
    @staticmethod
    def _get_impl(reco_type, speech_config, audio_config, language, source_language_config,
...
class SpeechSynthesisResult():
    ...
    def __init__(self, impl_result):
        ...
        self._audio_duration_milliseconds = impl_result.get_audio_duration_milliseconds()
    ...
    def audio_duration(self) -> timedelta:
        ...
        """
        return timedelta(milliseconds=self._audio_duration_milliseconds)
...
class SpeechSynthesisWordBoundaryEventArgs:
    ...
    def __init__(self, evt_args):
        ...
        self._duration_milliseconds = evt_args.get_duration_milliseconds()
        self._text_offset = evt_args.text_offset if evt_args.text_offset < 2 ** 31 else -1
        self._word_length = evt_args.word_length
        self._text = evt_args.text
        self._boundary_type = SpeechSynthesisBoundaryType(evt_args.boundary_type)
    ...
    def duration(self) -> timedelta:
        ...
        .. note::
          Added in version 1.21.0.
        """
        return timedelta(milliseconds=self._duration_milliseconds)
...
class AudioDataStream():
    ...
    def cancellation_details(self) -> "SpeechSynthesisCancellationDetails":
        ...
        Returns `None` if there was no cancellation.
        """
        return self._impl.cancellation_details
...
class SourceLanguageRecognizer(Recognizer):
    ...
    def __init__(self, speech_config: SpeechConfig,
        ...
        self._impl = self._get_impl(impl.SourceLanguageRecognizer, speech_config, auto_detect_source_language_config,
                                    audio_config)
